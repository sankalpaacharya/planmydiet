...
export  const generatePlanPrompt = ({weight, height, gender, weightloss, dietpreference, age, goal, activitylevel, calorieintake, duration}:DietPlanType):string=>{return `
